...
const usuariosAppRoutes = require('./usuariosAppRoutes');
const notificationsRoutes = require('./notificationsRoutes');
const notificationRecipientsRoutes = require('./notificationRecipientsRoutes');

router.use('/usuarios-app', usuariosAppRoutes);
router.use('/notifications', notificationsRoutes);
router.use('/notification-recipients', notificationRecipientsRoutes);
